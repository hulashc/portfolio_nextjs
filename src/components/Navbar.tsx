...
export function Navbar() {
  ...
  return (
    <div className="w-full p-3 md:p-4 pb-0 md:pb-0 max-w-screen overflow-x-hidden" style={{ backgroundColor: bg }}>
      <nav
      ...
      >
        ...
        <div className="flex items-center justify-center px-1 sm:px-2 md:px-4 overflow-hidden" style={{ borderRight: `1px solid ${borderColor}` }}>
          <h1 className="text-center" style={{ color: text }}>
      ...
      <div className={`w-full ${isDark ? 'dark' : 'light'}`} style={{ backgroundColor: bg, marginTop: "-2px" }}>
        <div className="grid grid-cols-2 gap-0" style={{ backgroundColor: bg, border: `1px solid ${borderColor}` }}>
          <Link 
            href="/projects"
            className="nav-box flex items-center justify-center cursor-pointer min-h-[48px] p-3 sm:p-4"
