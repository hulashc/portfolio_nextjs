...
export default function Ghost({ isDark }: GhostProps) {
  const bodyColor = isDark ? '#E3DACC' : '#333333';
  const pupilColor = '#31F68D';
  const shadowColor = isDark ? 'rgba(255,255,240,0.7)' : 'rgba(0,0,0,0.6)';
  ...
  return (
    <>
      <style>{`
        ...
        @keyframes flicker0 {
          0%, 49%   { background-color: ${bodyColor}; }
          50%, 100% { background-color: transparent; }
        }

        @keyframes flicker1 {
          0%, 49%   { background-color: transparent; }
          50%, 100% { background-color: ${bodyColor}; }
        }
