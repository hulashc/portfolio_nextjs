...
export default function Footer({ isDark, text, borderColor }: FooterProps) {
  return (
    <div style={{ borderBottom: `1px solid ${borderColor}`, borderLeft: `1px solid ${borderColor}`, borderRight: `1px solid ${borderColor}` }} className="p-3 md:p-4">
      <div className="flex flex-col items-center gap-4 md:grid md:grid-cols-3">
        <div className="text-center md:text-left">
          <p className="text-sm" style={{ color: text }}>London, UK · Open to work</p>
          <p className="text-sm" style={{ color: text }}>Built with Next.js · Vercel</p>
        </div>
        ...
        <div className="flex flex-wrap items-center justify-center md:justify-end gap-2">
          <a href="mailto:hulashc@gmail.com" style={{ border: `1px solid ${borderColor}`, padding: '13px', cursor: 'pointer', display: 'flex', lineHeight: 0 }}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill={text}>
              <path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"/>
            </svg>
          </a>
          <a href="https://www.linkedin.com/in/hulash/" target="_blank" rel="noopener noreferrer" style={{ border: `1px solid ${borderColor}`, padding: '13px', cursor: 'pointer', display: 'flex', lineHeight: 0 }}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill={text}>
          ...
          <a href="https://github.com/hchand" target="_blank" rel="noopener noreferrer" style={{ border: `1px solid ${borderColor}`, padding: '13px', cursor: 'pointer', display: 'flex', lineHeight: 0 }}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill={text}>
          ...
          <a href="https://instagram.com/hulash__chand" target="_blank" rel="noopener noreferrer" style={{ border: `1px solid ${borderColor}`, padding: '13px', cursor: 'pointer', display: 'flex', lineHeight: 0 }}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill={text}>
          ...
          <a href="https://medium.com/@hulashc" target="_blank" rel="noopener noreferrer" style={{ border: `1px solid ${borderColor}`, padding: '13px', cursor: 'pointer', display: 'flex', lineHeight: 0 }}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill={text}>
          ...
          <a href="https://classical.music.apple.com/us/album/1670601344" target="_blank" rel="noopener noreferrer" style={{ border: `1px solid ${borderColor}`, padding: '8px 12px', cursor: 'pointer', textDecoration: 'none' }}>
            <p className="text-sm mb-1" style={{ color: text }}>NOW PLAYING</p>
            <div className="flex items-center gap-2">
              ...
              <div>
                <p className="text-sm font-bold" style={{ color: text }}>Utopia</p>
                <p className="text-sm" style={{ color: text, opacity: 0.6 }}>Horacio Pagani</p>
              </div>
